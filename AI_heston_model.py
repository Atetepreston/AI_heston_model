...
class Heston_Model:
    def __init__(self, K, weeks, S0, r, v0, theta, kappa, sigma, rho):
        self.K = K
        self.weeks = weeks
        self.t = weeks / 52  # ✅ Convert weeks to years internally
        self.S0 = S0
        self.r = r
        self.v0 = v0
        self.theta = theta
...
weeks = st.number_input("Time to Maturity in Weeks", value=52)
...
if st.button("Calculate Call Option Price"):
    model = Heston_Model(K, weeks, S0, r, v0, theta, kappa, sigma, rho)
